...
static void imprimirInfoCancion(const Cancion& cancion, int indice, int total) {
    cout << "\n-------------------- REPRODUCIENDO --------------------" << endl;
    ...
    cout << "  Simulacion: [Datos de la cancion]" << endl;
    cout << "-------------------------------------------------------" << endl;
}
...
void reproducirAleatorioTemporizado(Cancion* arregloCanciones, int tamanoTotal) {
    ...
    while (cancionesReproducidas < K) {
        ...
        if (cancionesReproducidas < K) {
            cout << "\nAuto-avance despues de 3 segundos." << endl;
        }
    }
    ...
    cout << "Opciones de reproduccion:" << endl;
    cout << "1.- Reproducir 2.- Detener...." << endl;
    cout << "*Todas las opciones que apliquen (siguiente, previa, repetir, etc.)" << endl;
}
